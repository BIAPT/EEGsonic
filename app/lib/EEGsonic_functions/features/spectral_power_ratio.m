function [ratio_beta_alpha,ratio_alpha_theta] = spectral_power_ratio(eeg_data,eeg_info,params)
%SPECTRAL POWER RATIO Summary of this function goes here
%   Detailed explanation goes here

%% Create params struct for Chronux function
    params.tapers = [params.time_bandwidth params.number_tapers];
    params.Fs = eeg_info.sampling_rate;
    params.trialave = 1;
    window_parameters = [params.window_size params.step_size];    

    %% Theta
    params.fpass = [params.theta_bandwith];
    ...
    %% Beta
    params.fpass = [params.beta_bandwith];
    ...
    %% Alpha
    params.fpass = [params.alpha_bandwith];
