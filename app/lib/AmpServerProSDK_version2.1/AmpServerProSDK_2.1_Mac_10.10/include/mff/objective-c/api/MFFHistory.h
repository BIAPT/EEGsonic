 ...
 *  @author Robert Bell.
 *  @remarks
 *  An MFF resource representing a history resource in the MFF. Please see
 ...
 *  ------<br>
 */
@interface MFFHistory : MFFResource {
...
/**
 *  The entires list for this history.
 *  <b>Notes:</b><br>
 *  &nbsp; 1) This is a list of type Entry. See the Entry class for more information.<br>
 **/
