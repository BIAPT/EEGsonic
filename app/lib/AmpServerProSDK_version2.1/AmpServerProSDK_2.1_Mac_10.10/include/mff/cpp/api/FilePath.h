		...
		namespace services{
			...
			namespace mff{
				...
				namespace api{
					 ...
					 *  ------<br>
					 */
					class FilePath : virtual public EGIBase::EGIObject{
					...
					public:
						 ...
						 *  &nbsp; N/A<br>
						 */
						FilePath&  operator=(const FilePath& source);
						 ...
						 */
						virtual FilePath *init(EGIObject *eObject);
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual void setFilePath(EGIBase::EGIXStringWrap filePath);
						...
						/**
						 *  Sets type for this file path.
						 *  <b>Notes:</b><br>
						 *  &nbsp; N/A<br>
						 *  ------<br>
						 *  <b>Arguments:</b><br>
						 *  &nbsp; 1) type: The file path type.<br>
						 *  ------<br>
						 *  <b>Return:</b><br>
						 *  &nbsp; void: N/A<br>
						 *  ------<br>
						 ...
						 *  ------<br>
						 *  <b>Return:</b><br>
						 *  &nbsp; 1) std::string *: The file path type.<br>
						 *  ------<br>
						 *  <b>Throws</b><br>
						 *  &nbsp; N/A<br>
						 */
						...
						/**
						 *  Sets the creator for this file path.
						 *  <b>Notes:</b><br>
						 *  &nbsp; N/A<br>
						 *  ------<br>
						 *  <b>Arguments:</b><br>
						 *  &nbsp; 1) creator: The file path creator.<br>
						 *  ------<br>
						 *  <b>Return:</b><br>
						 *  &nbsp; N/A<br>
						 *  ------<br>
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual void setCreator(EGIBase::EGIXStringWrap creator);
						
						/**
						 *  Gets the creator for this file path.
						 *  <b>Notes:</b><br>
						 *  &nbsp; N/A<br>
						 *  ------<br>
						 *  <b>Arguments:</b><br>
						 ...
						 *  ------<br>
						 *  <b>Return:</b><br>
						 *  &nbsp; 1) std::string *: The file path creator.<br>
						 *  ------<br>
						 *  <b>Throws</b><br>
						 *  &nbsp; N/A<br>
						 */
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual EGIBase::ClassID getClassID(){return FilePath::classID;}
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual std::string toString() const {return EGIObject::toString() + "::FilePath";}
						 ...
						 */
						static const EGIBase::ClassID classID = 'FITH';
