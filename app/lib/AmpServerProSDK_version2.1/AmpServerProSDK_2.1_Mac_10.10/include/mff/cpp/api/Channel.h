		...
		namespace services{
			...
			namespace mff{
				...
				namespace api{
                     ...
                     *
                     *  ------<br>
					 *  Update (002): 2012-01-18: Added constructor initializations, updated naming,
                     *  and resetting of members in set functions.<br>
					 *  ------<br>
                     *
                     *  ------<br>
					 ...
					 *  ------<br>
					 */
					class Channel : virtual public EGIBase::EGIObject{
					...
					public:
						 ...
						 */
						virtual Channel *init(EGIObject *eObject);
						 ...
						 *  ------<br>
						 *  <b>Arguments:</b><br>
						 *  &nbsp; 1) channelData: The channel data.<br>
						 *  ------<br>
						 *  <b>Return:</b><br>
						 *  &nbsp; void: N/A<br>
						 *  ------<br>
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual void setChannelData(EGIBase::EGIXStringWrap channelData);
						 ...
						 *  ------<br>
						 *  <b>Return:</b><br>
						 *  &nbsp; 1) const std::string *: The channel data.<br>
						 *  ------<br>
						 *  <b>Throws</b><br>
						 *  &nbsp; N/A<br>
						 */
						virtual const std::string *getChannelData();
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual EGIBase::ClassID getClassID(){return Channel::classID;}
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual std::string toString() const {return EGIObject::toString() + "::Channel";}
						 ...
						 */
						static const EGIBase::ClassID classID = 'CHEL';
