...
#ifndef Entry_DEFINED
#define Entry_DEFINED
		...
		namespace services{
			...
			namespace mff{
				...
				namespace api{
					 ...
					 *  ------<br>
					 */
					class Entry : virtual public EGIBase::EGIObject{
					...
					public:
						 ...
						 */
						virtual Entry *init(EGIObject *eObject);
						
						/**
						 *  Sets the entry for this entry.
						 *  <b>Notes:</b><br>
						 *  &nbsp; N/A<br>
						 *  ------<br>
						 *  <b>Arguments:</b><br>
						 *  &nbsp; 1) entry: The entry.<br>
						 *  ------<br>
						 *  <b>Return:</b><br>
						 *  &nbsp; void: N/A<br>
						 *  ------<br>
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual void setEntry(EGIBase::EGIObject *entry);
						
						/**
						 *  Gets the entry for this entry.
						 *  <b>Notes:</b><br>
						 *  &nbsp; N/A<br>
						 *  ------<br>
						 *  <b>Arguments:</b><br>
						 ...
						 *  ------<br>
						 *  <b>Return:</b><br>
						 *  &nbsp; 1) EGIBase::EGIObject *: The entry.<br>
						 *  ------<br>
						 *  <b>Throws</b><br>
						 *  &nbsp; N/A<br>
						 */
						virtual EGIBase::EGIObject *getEntry();
						
						/**
						 *  Sets type of this entry.
						 *  <b>Notes:</b><br>
						 *  &nbsp; N/A<br>
						 *  ------<br>
						 *  <b>Arguments:</b><br>
						 *  &nbsp; 1) type: The entry type.<br>
						 *  ------<br>
						 *  <b>Return:</b><br>
						 *  &nbsp; void: N/A<br>
						 *  ------<br>
						 ...
						 *  ------<br>
						 *  <b>Return:</b><br>
						 *  &nbsp; 1) std::string *: The entry type.<br>
						 *  ------<br>
						 *  <b>Throws</b><br>
						 *  &nbsp; N/A<br>
						 */
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual EGIBase::ClassID getClassID(){return Entry::classID;}
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual std::string toString() const {return EGIObject::toString() + "::Entry";}
						 ...
						 */
						static const EGIBase::ClassID classID = 'ENRY';
