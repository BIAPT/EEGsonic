...
#ifndef XMLLocalFileResource_DEFINED
#define XMLLocalFileResource_DEFINED
		...
		namespace services{
			...
			namespace mff{
				...
				namespace util{
                     ...
                     *
                     *  ------<br>
                     *  Update: 2012-01-27: Added MFF version support.<br>
                     *  ------<br>
                     *
                     *  ------<br>
                     *  Update: 2012-01-27: Added sensor layout.<br>
                     *  ------<br>
                     *
                     *  ------<br>
                     *  Update: 2012-03-26: Acquisition method now being set corrrectly.<br>
                     *  ------<br>
                     *
                     *  ------<br>
                     *  Update: 2012-12-13: Added JTF category support.<br>
                     *  ------<br>
					 *
					 *  ------<br>
                     *  Update: 2013-2-11: Updated for channel status change in categories.xml.
					 *						Updated sensor objects in sensorlayout.xml and coordinates.xml. <br>
                     *  ------<br>
					 *
					 *  ------<br>
                     *  Update: 2013-12-03: Added support for Physio 16 - DFB <br>
                     *  ------<br>


					 */
					class XMLLocalFileResource : virtual public XMLResource{
					...
					public:
						 ...
						 *  ------<br>
						 *  <b>Return:</b><br>
						 *  &nbsp; XMLLocalFileResource *: N/A<br>
						 *  ------<br>
						 *  <b>Throws:</b><br>
						 *  &nbsp; N/A<br>
						 */
						virtual XMLLocalFileResource *clone() const;
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual XMLLocalFileResource *create() const;
						 ...
						 *  ------<br>
						 *  <b>Return:</b><br>
						 *  &nbsp; 1) XMLLocalFileResource *: This object.<br>
						 *  ------<br>
						 *  <b>Throws:</b><br>
						 ...
						 */
						virtual XMLLocalFileResource *init(EGIObject *eObject);
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual EGIBase::ClassID getClassID(){return XMLLocalFileResource::classID;}
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual std::string toString() const {return EGIObject::toString() + "::XMLLocalFileResource";}
					...
					protected:
						 ...
						 */
						XMLLocalFileResource(const XMLLocalFileResource& source);
						 ...
						 *  &nbsp; 1) EGIBase::MethodNotSupported_EGIException.<br>
						 */
						XMLLocalFileResource&  operator=(const XMLLocalFileResource& source);
...
#endif // XMLLocalFileResource_DEFINED
