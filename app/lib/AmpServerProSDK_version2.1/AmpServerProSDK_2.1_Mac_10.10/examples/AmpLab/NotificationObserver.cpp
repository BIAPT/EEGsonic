...
NotificationObserver::NotificationObserver(const NotificationObserver& source) : EGIObject(source){
  ...
  throw EGIBase::MethodNotSupported_EGIException("NotificationObserver::NotificationObserver\
   (const NotificationObserver& source)");
...
#ifdef __USE_EXCEPTIONS__
  throw EGIBase::MethodNotSupported_EGIException("NotificationObserver& NotificationObserver::operator=\
   (const NotificationObserver& source)");
#endif //__USE_EXCEPTIONS__
  return *this;
}
