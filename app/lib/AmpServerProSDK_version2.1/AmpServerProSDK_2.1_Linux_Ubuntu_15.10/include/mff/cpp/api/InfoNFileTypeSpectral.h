...
#ifndef InfoNFileTypeSpectral_DEFINED
#define InfoNFileTypeSpectral_DEFINED
		...
		namespace services{
			...
			namespace mff{
				...
				namespace api{
					...
					/**
					 *  InfoNFileTypeSpectral Class.
					 *  @author Robert Bell.
					 *  @remarks
					 *  Place notes here.
					 *
					 *  ------<br>
					 *  Update (001): 2012-03-19: Class creation.<br>
					 *  ------<br>
                     *
                     *  ------<br>
					 ...
					 *  ------<br>
					 */
					class InfoNFileTypeSpectral : virtual public EGIBase::EGIObject{
					...
					public:
						 ...
						 *  &nbsp; N/A<br>
						 */
						InfoNFileTypeSpectral(const InfoNFileTypeSpectral& source);
						 ...
						 *  &nbsp; N/A<br>
						 */
						InfoNFileTypeSpectral&  operator=(const InfoNFileTypeSpectral& source);
						 ...
						 *  ------<br>
						 *  <b>Return:</b><br>
						 *  &nbsp; InfoNFileTypeSpectral *: N/A<br>
						 *  ------<br>
						 *  <b>Throws:</b><br>
						 *  &nbsp; N/A<br>
						 */
						virtual InfoNFileTypeSpectral *clone() const;
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual InfoNFileTypeSpectral *create() const;
						 ...
						 *  ------<br>
						 *  <b>Return:</b><br>
						 *  &nbsp; 1) InfoNFileTypeSpectral *: This object.<br>
						 *  ------<br>
						 *  <b>Throws:</b><br>
						 ...
						 */
						virtual InfoNFileTypeSpectral *init(EGIObject *eObject);
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual void setDeltaF(double deltaF);
						 ...
						 *  ------<br>
						 *  <b>Return:</b><br>
						 *  &nbsp; 1) double: The delta f.<br>
						 *  ------<br>
						 *  <b>Throws</b><br>
						 *  &nbsp; N/A<br>
						 */
						virtual double getDeltaF();
                        ...
                        /**
						 *  Sets the end time as present flag.
						 *  <b>Notes:</b><br>
						 *  &nbsp; N/A<br>
						 *  ------<br>
						 *  <b>Arguments:</b><br>
						 *  &nbsp; 1) endTimePresent: The end time as present flag.<br>
						 *  ------<br>
						 *  <b>Return:</b><br>
						 *  &nbsp; void: N/A<br>
						 *  ------<br>
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual void setEndTimePresent(bool endTimePresent);
                        
                        /**
						 *  Gets whether the end time is present flag.
						 *  <b>Notes:</b><br>
						 *  &nbsp; N/A<br>
						 *  ------<br>
						 *  <b>Arguments:</b><br>
						 ...
						 *  ------<br>
						 *  <b>Return:</b><br>
						 *  &nbsp; 1) bool: Whether the end time is present flag.<br>
						 *  ------<br>
						 *  <b>Throws</b><br>
						 *  &nbsp; N/A<br>
						 */
						virtual bool getEndTimePresent();
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual EGIBase::ClassID getClassID(){return InfoNFileTypeSpectral::classID;}
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual std::string toString() const {return EGIObject::toString() + "::InfoNFileTypeSpectral";}
						 ...
						 */
						static const EGIBase::ClassID classID = 'INSP';
...
#endif // InfoNFileTypeSpectral_DEFINED
