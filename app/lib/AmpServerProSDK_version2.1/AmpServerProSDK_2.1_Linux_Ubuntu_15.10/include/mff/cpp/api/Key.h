		...
		namespace services{
			...
			namespace mff{
				...
				namespace api{
					 ...
					 *
					 *  ------<br>
					 *  Update (001): 2011-02-11: Class creation.<br>
					 *  ------<br>
                     *
                     *  ------<br>
					 ...
					 *  ------<br>
					 */
					class Key : virtual public EGIBase::EGIObject{
					...
					public:
						 ...
						 */
						virtual Key *init(EGIObject *eObject);
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual void setKeyCode(EGIBase::EGIXStringWrap code);
						 ...
						 *  ------<br>
						 *  <b>Return:</b><br>
						 *  &nbsp; 1) std::string *: The key code.<br>
						 *  ------<br>
						 *  <b>Throws</b><br>
						 *  &nbsp; N/A<br>
						 */
						virtual std::string *getKeyCode();
						 ...
						 *  ------<br>
						 *  <b>Arguments:</b><br>
						 *  &nbsp; 1) description: The key description.<br>
						 *  ------<br>
						 *  <b>Return:</b><br>
						 *  &nbsp; N/A<br>
						 *  ------<br>
						...
						/**
						 *  Gets the description for this key.
						 *  <b>Notes:</b><br>
						 *  &nbsp; N/A<br>
						 *  ------<br>
						 *  <b>Arguments:</b><br>
						 ...
						 *  ------<br>
						 *  <b>Return:</b><br>
						 *  &nbsp; 1) std::string *: The key description.<br>
						 *  ------<br>
						 *  <b>Throws</b><br>
						 *  &nbsp; N/A<br>
						 */
						...
						/**
						 *  Sets the data for this key.
						 *  <b>Notes:</b><br>
						 *  &nbsp; N/A<br>
						 *  ------<br>
						 *  <b>Arguments:</b><br>
						 *  &nbsp; 1) data: The key data.<br>
						 *  ------<br>
						 *  <b>Return:</b><br>
						 *  &nbsp; void: N/A<br>
						 *  ------<br>
						...
						/**
						 *  Sets the data type for this key.
						 *  <b>Notes:</b><br>
						 *  &nbsp; N/A<br>
						 *  ------<br>
						 *  <b>Arguments:</b><br>
						 *  &nbsp; 1) dataType: The key data type.<br>
						 *  ------<br>
						 *  <b>Return:</b><br>
						 *  &nbsp; N/A<br>
						 *  ------<br>
						...
						/**
						 *  Gets the data type for this key.
						 *  <b>Notes:</b><br>
						 *  &nbsp; N/A<br>
						 *  ------<br>
						 *  <b>Arguments:</b><br>
						 ...
						 *  ------<br>
						 *  <b>Return:</b><br>
						 *  &nbsp; 1) std::string *: The key data type.<br>
						 *  ------<br>
						 *  <b>Throws</b><br>
						 *  &nbsp; N/A<br>
						 */
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual EGIBase::ClassID getClassID(){return Key::classID;}
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual std::string toString() const {return EGIObject::toString() + "::Key";}
						 ...
						 */
						static const EGIBase::ClassID classID = 'KKEY';
