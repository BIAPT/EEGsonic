...
/**@file
 *  LocalUnixMFFFactoryDelegate header.
 *  @author Robert Bell
 *  @date 01/09/2011
 *  @remarks
...
#ifndef LocalUnixMFFFactoryDelegate_DEFINED
#define LocalUnixMFFFactoryDelegate_DEFINED
		...
		namespace services{
			...
			namespace mff{
				...
				namespace api{
					...
					/**
					 *  LocalUnixMFFFactoryDelegate Class.
					 *  @author Robert Bell.
					 *  @remarks
					 *  Place notes here.
					 *
					 ...
					 *  ------<br>
					 */
					class LocalUnixMFFFactoryDelegate : virtual public protocols::MFFFactoryDelegate{
					...
					public:
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual ~LocalUnixMFFFactoryDelegate();
						 ...
						 *  ------<br>
						 *  <b>Return:</b><br>
						 *  &nbsp; LocalUnixMFFFactoryDelegate *: N/A<br>
						 *  ------<br>
						 *  <b>Throws:</b><br>
						 *  &nbsp; N/A<br>
						 */
						virtual LocalUnixMFFFactoryDelegate *clone() const;
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual LocalUnixMFFFactoryDelegate *create() const;
						 ...
						 *  ------<br>
						 *  <b>Return:</b><br>
						 *  &nbsp; 1) LocalUnixMFFFactoryDelegate *: This object.<br>
						 *  ------<br>
						 *  <b>Throws:</b><br>
						 ...
						 */
						virtual LocalUnixMFFFactoryDelegate *init(EGIObject *eObject);
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual EGIBase::ClassID getClassID(){return LocalUnixMFFFactoryDelegate::classID;}
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual std::string toString() const {return EGIObject::toString() + "::LocalUnixMFFFactoryDelegate";}
					...
					protected:
						 ...
						 */
						LocalUnixMFFFactoryDelegate(const LocalUnixMFFFactoryDelegate& source);
						 ...
						 *  &nbsp; 1) EGIBase::MethodNotSupported_EGIException.<br>
						 */
						LocalUnixMFFFactoryDelegate&  operator=(const LocalUnixMFFFactoryDelegate& source);
...
#endif // LocalUnixMFFFactoryDelegate_DEFINED
