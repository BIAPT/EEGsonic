...
#ifndef Fields_DEFINED
#define Fields_DEFINED
		...
		namespace services{
			...
			namespace mff{
				...
				namespace api{
					 ...
					 *  ------<br>
					 */
					class Fields : virtual public com::egi::services::mff::api::MFFResource{
					...
					public:
						 ...
						 *  &nbsp; N/A<br>
						 */
						Fields(std::string uri, EGIObject *resourceDelegate, MFFResourceType *resourceType);
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual Fields *create(std::string uri, EGIObject *resourceDelegate, MFFResourceType *resourceType) const;
						 ...
						 */
						virtual Fields *init(EGIObject *eObject);
						
						/**
						 *  Sets the epochs for this Fields.
						 *  <b>Notes:</b><br>
						 *  &nbsp; 1) This will release replace any current fields.<br>
						 *  ------<br>
						 *  <b>Arguments:</b><br>
						 *  &nbsp; 1) fields: The Fields. Callee owned.<br>
						 *  ------<br>
						 *  <b>Return:</b><br>
						 *  &nbsp; N/A<br>
						 *  ------<br>
						...
						/**
						 *  Gets the fields for this Fields.
						 *  <b>Notes:</b><br>
						 *  &nbsp; N/A<br>
						 *  ------<br>
						 *  <b>Arguments:</b><br>
						 ...
						 *  ------<br>
						 *  <b>Return:</b><br>
						 *  &nbsp;  1) std::vector<Field *> *: The Fields.<br>
						 *  ------<br>
						 *  <b>Throws</b><br>
						 *  &nbsp; N/A<br>
						 */
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual EGIBase::ClassID getClassID(){return Fields::classID;}
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual std::string toString() const {return EGIObject::toString() + "::Fields";}
						 ...
						 */
						static const EGIBase::ClassID classID = 'FISD';
					...
					protected:
						 ...
						 *  &nbsp; 1) EGIBase::MethodNotSupported_EGIException.<br>
						 */
						Fields&  operator=(const Fields& source);
