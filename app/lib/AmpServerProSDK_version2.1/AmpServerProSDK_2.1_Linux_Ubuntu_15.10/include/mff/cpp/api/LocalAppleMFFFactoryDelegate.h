...
/**@file
 *  LocalAppleMFFFactoryDelegate header.
 *  @author Robert Bell
 *  @date 01/09/2011
 *  @remarks
...
#ifndef LocalAppleMFFFactoryDelegate_DEFINED
#define LocalAppleMFFFactoryDelegate_DEFINED
		...
		namespace services{
			...
			namespace mff{
				...
				namespace api{
					...
					/**
					 *  LocalAppleMFFFactoryDelegate Class.
					 *  @author Robert Bell.
					 *  @remarks
					 *  Place notes here.
					 *
					 *  ------<br>
					 *  Update: 2011-09-01: Class creation.<br>
					 *  ------<br>
                     *
                     *  ------<br>
					 *  Update: 2012-12-08: Added JTF Category support.<br>
					 *  ------<br>
					 */
					class LocalAppleMFFFactoryDelegate : virtual public protocols::MFFFactoryDelegate{
					...
					public:
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual ~LocalAppleMFFFactoryDelegate();
						 ...
						 *  ------<br>
						 *  <b>Return:</b><br>
						 *  &nbsp; LocalAppleMFFFactoryDelegate *: N/A<br>
						 *  ------<br>
						 *  <b>Throws:</b><br>
						 *  &nbsp; N/A<br>
						 */
						virtual LocalAppleMFFFactoryDelegate *clone() const;
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual LocalAppleMFFFactoryDelegate *create() const;
						 ...
						 *  ------<br>
						 *  <b>Return:</b><br>
						 *  &nbsp; 1) LocalAppleMFFFactoryDelegate *: This object.<br>
						 *  ------<br>
						 *  <b>Throws:</b><br>
						 ...
						 */
						virtual LocalAppleMFFFactoryDelegate *init(EGIObject *eObject);
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual EGIBase::ClassID getClassID(){return LocalAppleMFFFactoryDelegate::classID;}
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual std::string toString() const {return EGIObject::toString() + "::LocalAppleMFFFactoryDelegate";}
						 ...
						 */
						static const EGIBase::ClassID classID = 'LOTE';
					...
					protected:
						 ...
						 */
						LocalAppleMFFFactoryDelegate(const LocalAppleMFFFactoryDelegate& source);
						 ...
						 *  &nbsp; 1) EGIBase::MethodNotSupported_EGIException.<br>
						 */
						LocalAppleMFFFactoryDelegate&  operator=(const LocalAppleMFFFactoryDelegate& source);
...
#endif // LocalAppleMFFFactoryDelegate_DEFINED
