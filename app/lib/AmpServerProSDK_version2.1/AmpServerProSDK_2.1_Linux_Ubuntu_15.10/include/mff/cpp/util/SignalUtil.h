...
#ifndef SignalUtil_DEFINED
#define SignalUtil_DEFINED
		...
		namespace services{
			...
			namespace mff{
				...
				namespace util{
					 ...
					 *  ------<br>
					 */
					class SignalUtil : virtual public EGIBase::EGIObject{
					...
					public:
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual SignalUtil *clone() const;
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual SignalUtil *create() const;
						 ...
						 */
						virtual SignalUtil *init(EGIObject *eObject);
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual EGIBase::ClassID getClassID(){return SignalUtil::classID;}
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual std::string toString() const {return EGIObject::toString() + "::SignalUtil";}
						 ...
						 */
						static const EGIBase::ClassID classID = 'SIIL';
                        ...
                        static uint8_t *packSignalInfo(int32_t signalDepth, int32_t signalFrequency);
                        
                        static int32_t *unpackSignalInfo(const uint8_t *signalInfo);
					...
					protected:
						 ...
						 */
						SignalUtil(const SignalUtil& source);
						 ...
						 *  &nbsp; 1) EGIBase::MethodNotSupported_EGIException.<br>
						 */
						SignalUtil&  operator=(const SignalUtil& source);
