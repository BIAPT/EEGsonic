...
/**@file
 *  MFFFactoryDelegate protocol header.
 *  @author Robert Bell
 *  @date 28/06/2011
 *  @remarks
 ...
 *  @author Robert Bell.
 *  @remarks
 *  All delegats to an MFF factory must implement these
 *  methods. An MFFFactory class pushes most (if not all)
 *  of it's actual functionality to its delegate.
 *
 *  ------<br>
 *  Update: 2011-06-28: Class creation.<br>
 *  ------<br>
 */
@protocol MFFFactoryDelegate <NSObject>
