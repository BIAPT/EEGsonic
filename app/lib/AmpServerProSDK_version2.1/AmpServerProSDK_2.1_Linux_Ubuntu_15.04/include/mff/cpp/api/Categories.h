...
#ifndef Categories_DEFINED
#define Categories_DEFINED
		...
		namespace services{
			...
			namespace mff{
				...
				namespace api{
					 ...
					 *  ------<br>
					 */
					class Categories : virtual public com::egi::services::mff::api::MFFResource{
					...
					public:
						 ...
						 *  &nbsp; N/A<br>
						 */
						Categories(std::string uri, EGIObject *resourceDelegate, MFFResourceType *resourceType);
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual Categories *clone() const;
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual Categories *create() const;
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual Categories *create(std::string uri, EGIObject *resourceDelegate, MFFResourceType *resourceType) const;
						 ...
						 */
						virtual Categories *init(EGIObject *eObject);
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual void setCategories(std::vector<Category *> *categories);
						 ...
						 *  ------<br>
						 *  <b>Return:</b><br>
						 *  &nbsp;  1) std::vector<Category *> *: The categories.<br>
						 *  ------<br>
						 *  <b>Throws</b><br>
						 *  &nbsp; N/A<br>
						 */
						virtual std::vector<Category *> *getCategories();
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual EGIBase::ClassID getClassID(){return Categories::classID;}
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual std::string toString() const {return com::egi::services::mff::api::MFFResource::toString() + "::Categories";}
					...
					protected:
						 ...
						 */
						Categories(const Categories& source);
						 ...
						 *  &nbsp; 1) EGIBase::MethodNotSupported_EGIException.<br>
						 */
						Categories&  operator=(const Categories& source);
