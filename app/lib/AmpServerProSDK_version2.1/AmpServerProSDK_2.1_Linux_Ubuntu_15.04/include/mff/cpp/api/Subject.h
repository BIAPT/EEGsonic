		...
		namespace services{
			...
			namespace mff{
				...
				namespace api{
					 ...
					 *  ------<br>
					 */
					class Subject : virtual public com::egi::services::mff::api::MFFResource{
					...
					public:
						 ...
						 *  &nbsp; N/A<br>
						 */
						Subject(std::string uri, EGIObject *resourceDelegate, MFFResourceType *resourceType);
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual Subject *create(std::string uri, EGIObject *resourceDelegate, MFFResourceType *resourceType) const;
						 ...
						 */
						virtual Subject *init(EGIObject *eObject);
						
						/**
						 *  Sets the fields for this Subject.
						 *  <b>Notes:</b><br>
						 *  &nbsp; N/A<br>
						 *  ------<br>
						 *  <b>Arguments:</b><br>
						 *  &nbsp; 1) fields: The Subject fields.<br>
						 *  ------<br>
						 *  <b>Return:</b><br>
						 *  &nbsp; N/A<br>
						 *  ------<br>
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual void setFields(std::vector<Field *> *fields);
						
						/**
						 *  Gets the fields for this Subject.
						 *  <b>Notes:</b><br>
						 *  &nbsp; N/A<br>
						 *  ------<br>
						 *  <b>Arguments:</b><br>
						 ...
						 *  ------<br>
						 *  <b>Return:</b><br>
						 *  &nbsp;  1) std::vector<Field *> *: The Subject fields.<br>
						 *  ------<br>
						 *  <b>Throws</b><br>
						 *  &nbsp; N/A<br>
						 */
						...
						/**
						 *  Sets the MRIs for this Subject.
						 *  <b>Notes:</b><br>
						 *  &nbsp; N/A<br>
						 *  ------<br>
						 *  <b>Arguments:</b><br>
						 *  &nbsp; 1) mris: The Subject MRIs.<br>
						 *  ------<br>
						 *  <b>Return:</b><br>
						 *  &nbsp; N/A<br>
						 *  ------<br>
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual void setMRIs(std::vector<std::string> *mris);
						
						/**
						 *  Gets the MRIs for this Subject.
						 *  <b>Notes:</b><br>
						 *  &nbsp; N/A<br>
						 *  ------<br>
						 *  <b>Arguments:</b><br>
						 ...
						 *  ------<br>
						 *  <b>Return:</b><br>
						 *  &nbsp;  1) std::vector<std::string> *: The Subject MRIs.<br>
						 *  ------<br>
						 *  <b>Throws</b><br>
						 *  &nbsp; N/A<br>
						 */
						virtual std::vector<std::string> *getMRIs();
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual EGIBase::ClassID getClassID(){return Subject::classID;}
						 ...
						 *  &nbsp; N/A<br>
						 */
						virtual std::string toString() const {return EGIObject::toString() + "::Subject";}
						 ...
						 */
						static const EGIBase::ClassID classID = 'SUCT';
