...
const defaultPreset = [
	...
	{fileName: 'slow_gloc_melody.ogg', trackName: 'bells', input:'/spr_alpha_theta', tone: true, reversed: false, gain: null, min: 0.1, max:0.20, peak: 0.12, pinToData: false, length: null},
	{fileName: 'res1_violins.mp3', trackName: 'violins', input:'/spr_alpha_theta', tone: true, reversed: false, gain: null, min: 0.18, max:0.4, peak: 0.25, pinToData: false, length: null},
	{fileName: 'res1_flutes.mp3', trackName: 'flutes', input:'/spr_alpha_theta', tone: true, reversed: false, gain: null, min: 0.28, max:0.45, peak: 0.35, pinToData: false, length: null},
	{fileName: 'fibflutemicroaccel.ogg', trackName: 'flute', input:'/fp_dpli_left_lateral', tone: true, reversed: false, gain: -20, min: 0, max:0, peak: 0, pinToData: false, length: null},
	{fileName: 'fibbsnmicroaccel.ogg', trackName: 'bassoon', input:'/fp_dpli_right_lateral', tone: true, reversed: false, gain: -20, min: 0, max:0, peak: 0, pinToData: false, length: null},
	{fileName: 'fibclarinetmicroaccel.ogg', trackName: 'clarinet', input:'/fp_dpli_left_midline', tone: true, reversed: false, gain: -20, min: 0, max:0, peak: 0, pinToData: false, length: null},
	{fileName: 'res1_flutes.mp3', trackName: 'flutes', input:'/spr_alpha_theta', tone: true, reversed: false, gain: null, min: 0.28, max:0.45, peak: 0.35, pinToData: false, length: null},
	{fileName: 'fibflutemicroaccel.ogg', trackName: 'flute', input:'/fp_dpli_left_lateral', tone: true, reversed: false, gain: -20, min: 0, max:0, peak: 0, pinToData: false, length: null},
	{fileName: 'fibbsnmicroaccel.ogg', trackName: 'bassoon', input:'/fp_dpli_right_lateral', tone: true, reversed: false, gain: -20, min: 0, max:0, peak: 0, pinToData: false, length: null},
	{fileName: 'fibclarinetmicroaccel.ogg', trackName: 'clarinet', input:'/fp_dpli_left_midline', tone: true, reversed: false, gain: -20, min: 0, max:0, peak: 0, pinToData: false, length: null},
...
var data = {
	'/fp_dpli_left_midline': {min: null, max: null, curr: null, mute: false, last5: []},
	'/fp_dpli_left_lateral': {min: null, max: null, curr: null, mute: false, last5: []}, 
	'/fp_dpli_right_midline': {min: null, max: null, curr: null, mute: false, last5: []}, 
	'/fp_dpli_right_lateral': {min: null, max: null, curr: null, mute: false, last5: []}, 
	'/fp_wpli_left_midline': {min: null, max: null, curr: null, mute: false, last5: []}, 
	'/fp_wpli_left_lateral': {min: null, max: null, curr: null, mute: false, last5: []}, 
	'/fp_wpli_right_midline': {min: null, max: null, curr: null, mute: false, last5: []}, 
	'/fp_wpli_right_lateral': {min: null, max: null, curr: null, mute: false, last5: []}, 
	'/hl_relative_position': {min: null, max: null, curr: null, mute: false, last5: []}, 
	'/pe_frontal': {min: null, max: null, curr: null, mute: false, last5: []}, 
	'/pe_parietal': {min: null, max: null, curr: null, mute: false, last5: []}, 
	'/pac_rpt_frontal': {min: null, max: null, curr: null, mute: false, last5: []}, 
	'/pac_rpt_parietal': {min: null, max: null, curr: null, mute: false, last5: []}, 
	'/spr_beta_alpha': {min: null, max: null, curr: null, mute: false, last5: []}, 
	'/spr_alpha_theta': {min: null, max: null, curr: null, mute: false, last5: []}, 
	'/td_front_back': {min: null, max: null, curr: null, mute: false, last5: []},
	'/fp_dpli_left_midline_avg': {min: null, max: null, curr: null, mute: false, last5: []},
	'/fp_dpli_left_lateral_avg': {min: null, max: null, curr: null, mute: false, last5: []}, 
	'/fp_dpli_right_midline_avg': {min: null, max: null, curr: null, mute: false, last5: []}, 
	'/fp_dpli_right_lateral_avg': {min: null, max: null, curr: null, mute: false, last5: []}, 
	'/fp_wpli_left_midline_avg': {min: null, max: null, curr: null, mute: false, last5: []}, 
	'/fp_wpli_left_lateral_avg': {min: null, max: null, curr: null, mute: false, last5: []}, 
	'/fp_wpli_right_midline_avg': {min: null, max: null, curr: null, mute: false, last5: []}, 
	'/fp_wpli_right_lateral_avg': {min: null, max: null, curr: null, mute: false, last5: []}, 
	'/hl_relative_position_avg': {min: null, max: null, curr: null, mute: false, last5: []}, 
	'/pe_frontal_avg': {min: null, max: null, curr: null, mute: false, last5: []}, 
	'/pe_parietal_avg': {min: null, max: null, curr: null, mute: false, last5: []}, 
	'/pac_rpt_frontal_avg': {min: null, max: null, curr: null, mute: false, last5: []}, 
	'/pac_rpt_parietal_avg': {min: null, max: null, curr: null, mute: false, last5: []}, 
	'/spr_beta_alpha_avg': {min: null, max: null, curr: null, mute: false, last5: []}, 
	'/spr_alpha_theta_avg': {min: null, max: null, curr: null, mute: false, last5: []}, 
	'/td_front_back_avg': {min: null, max: null, curr: null, mute: false, last5: []},
}
...
function addNewTrack() {
	...
	sound.trackInfo.push({fileName: filename, trackName: filename.split('.')[0], input: null, tone: true, reversed: false, gain: null, min: 0, max: 1, peak: 1, pinToData: true, length: null},)
...
function loadOSCTable() {
	...
	for (const [key, value] of Object.entries(data)) {
  		...
  		document.getElementById(`reset${key}`).addEventListener('click', ()=>{
  			data[key] = {min: null, max: null, curr: null, mute: true, last5: []};
...
function updateData (oscMessage) {
	...
	if (data[address].last5.length == 5) {
		data[address].last5.shift();
	}
	data[address].last5.push(oscMessage.args[0])
	//updateAverage(oscMessage);
...
function updateAverage(oscMessage) {
	let average_address = oscMessage.address + '_avg';

	const average = list => list.reduce((prev, curr) => prev + curr) / list.length;

	data[average_address].curr = average(data[oscMessage].last5);

	// keeps track of last 5 averages also
	if (data[average_address].last5.length == 5) {
		data[average_address].last5.shift();
	}
	data[average_address].last5.push(oscMessage.args[0])
    	...
    	if (sound.trackInfo[i].input === oscMessage.address) {
    		...
    		if (oscMessage.address == '/spr_beta_alpha') {
				if (sound.sprSpeedup) {
    				...
    				sound.players[i].playbackRate = 1;
    			}
    		...
    		if (oscMessage.address == '/spr_alpha_theta') {
    			...
    			// console.log(data['/spr_alpha_theta'].last5);
    			// console.log(data['/spr_alpha_theta_avg'].curr);
    			// console.log(data['/spr_alpha_theta_avg'].last5)
...
function calculateGain(i, oscMessage) {
	...
	if (sound.trackInfo[i].max == sound.trackInfo[i].peak) { 
		...
		if (sound.trackInfo[i].pinToData) { // if it's relative to limits of data stream
			...
			console.log(sound.trackInfo[i].peak);
...
function setGain(i, value) { // value given in range of -1 to 1, -1 is silence, 0 is -10dB, 1 is 0dB.
	if (sound.trackInfo[i].input == '/spr_beta_alpha') {
		console.log(i + ', gain:' + value);
	}
